export const DIACRITIC_RANGES: readonly [number, number][] = [
  [0x0610, 0x061a],
  [0x064b, 0x065f],
  [0x0670, 0x0670],
  [0x06d6, 0x06ed],
...
export const HONORIFIC_RANGES: readonly [number, number][] = [
  [0x0610, 0x061a],
  [0x06d6, 0x06ed],
]

export const ZERO_WIDTH_CHARS: readonly number[] = [0x200c, 0x200d, 0x00ad]

export const ALIF_VARIANTS: readonly number[] = [0x0622, 0x0623, 0x0625, 0x0671, 0x0672, 0x0673]

export const PRESENTATION_FORMS_MAP: ReadonlyMap<number, string> = new Map([
  [0xfb50, '\u0671'], [0xfb51, '\u0671'],
